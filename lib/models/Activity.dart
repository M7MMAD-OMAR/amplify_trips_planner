...
class Activity extends Model {
  ...
  const Activity._internal(
      ...
      : _activityName = activityName,
        _trip = trip,
        _activityImageUrl = activityImageUrl,
        _activityImageKey = activityImageKey,
  ...
  factory Activity(
      ...
      String? activityImageKey,
      required TemporalDate activityDate,
      TemporalTime? activityTime,
  ...
  String toString() {
    ...
    buffer.write("activityDate=" +
        (_activityDate != null ? _activityDate!.format() : "null") +
        ", ");
    buffer.write("activityTime=" +
        (_activityTime != null ? _activityTime!.format() : "null") +
        ", ");
    buffer.write("category=" +
        (_category != null ? enumToString(_category)! : "null") +
        ", ");
  ...
  Activity.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _trip = json['trip']?['serializedData'] != null
            ? Trip.fromJson(
                new Map<String, dynamic>.from(json['trip']['serializedData']))
            : null,
        _activityImageUrl = json['activityImageUrl'],
        _activityImageKey = json['activityImageKey'],
        _activityDate = json['activityDate'] != null
            ? TemporalDate.fromString(json['activityDate'])
            : null,
        _activityTime = json['activityTime'] != null
            ? TemporalTime.fromString(json['activityTime'])
            : null,
        _category = enumFromString<ActivityCategory>(
            json['category'], ActivityCategory.values),
  ...
  Map<String, dynamic> toJson() => {
        ...
        'activityDate': _activityDate?.format(),
        'activityTime': _activityTime?.format(),
        'category': enumToString(_category),
  ...
  static final QueryField ACTIVITYIMAGEURL =
      QueryField(fieldName: "activityImageUrl");
  static final QueryField ACTIVITYIMAGEKEY =
      QueryField(fieldName: "activityImageKey");
